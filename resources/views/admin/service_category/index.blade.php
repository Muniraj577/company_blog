...
@section('service-category', 'active')
@section('content')
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <table id="ServiceCategory" class="table table-responsive-xl text-center">
                                <thead>
                                    <tr>
                                        <th>S.N</th>
                                        <th>Title</th>
                                        ...
                                        <tr>
                                            ...
                                            <div class="d-inline-flex">
                                                <a href="{{ route("admin.service.category.edit", $category->id) }}"
                                                    class="btn btn-sm btn-primary" title="Edit Service Category">
