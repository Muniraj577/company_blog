                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <select name="client_category_id" class="form-control">
                                                        <option value="">Select Category</option>
                                                        @foreach ($categories as $key => $category)
                                                            <option value="{{ $category->id }}"
                                                                {{ $category->id == old('client_category_id', $client->client_category_id) ? 'selected' : '' }}>
                                                                {{ $category->title }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    <span class="require client_category_id text-danger"></span>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <label for="logo">Upload Client Logo (2MB)&nbsp;<span
                                                            class="req">*</span></label>
                                                </div>
                                                <div class="col-md-8">
                                                    <input type="file" class="form-control" name="logo"
                                                        onchange="showImg(this, 'imgPreview')">
                                                    <img src="{{ $client->getLogo($client->logo) }}" class="imgSize"
                                                        id="imgPreview">
