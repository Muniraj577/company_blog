                                ...
                                <div class="col-md-6">
                                    <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <textarea name="description" class="form-control" style="width: 100%;"
                                                        cols="30" rows="10">{{ old('description', $about->description) }}</textarea>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <select name="status" class="form-control">
                                                        <option value="1" {{ old('status', $about->status) == '1' ? 'selected' : '' }}>
                                                            Active</option>
                                                        <option value="0" {{ old('status', $about->status) == '0' ? 'selected' : '' }}>
                                                            Inactive</option>
                                                    </select>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <label for="image">Upload About Image (2MB)&nbsp;<span
                                                            class="req">*</span></label>
                                                </div>
                                                <div class="col-md-8">
                                                    <input type="file" class="form-control" name="image"
                                                        onchange="showImg(this, 'imgPreview')">
                                                    <img src="{{ $about->getImg($about->image) }}" class="imgSize" id="imgPreview">
